  ...
  return (
    <>
      <Hero
        ...
        subtitle="Bij MOZa staan ondernemers voorop. Elk uur minder aan gedoe met de overheid, is een uur meer ondernemen. We zorgen voor overzicht en makkelijk zaken doen. Met elkaar bouwen we zo aan nieuwe digitale snelwegen."
      />
      ...
      <div className="">
        <Container>
          <div className="">
            <div className="xs:w-full m-4 mb-4 flex flex-col rounded-xs rounded-tr-4xl bg-[#d9ebf7] p-4 pb-3 lg:w-2/3">
              <p className="">
                <svg
                  className="mb-2"
                  width="24"
                ...
                >
                  ...
                  />
                  <path
                    d="M10.71 6.93C10.71 6.59 10.82 6.3 11.04 6.05C11.26 5.8 11.58 5.67 11.99 5.67C12.4 5.67 12.71 5.79 12.93 6.03C13.15 6.27 13.26 6.57 13.26 6.93C13.26 7.25 13.15 7.54 12.93 7.79C12.71 8.04 12.39 8.16 11.99 8.16C11.58 8.16 11.27 8.04 11.04 7.81C10.82 7.57 10.71 7.28 10.71 6.93ZM13.11 9.32V18.28H10.9V9.41L13.11 9.32Z"
                    fill="white"
                  />
                </svg>{" "}
                MijnOverheid Zakelijk is in ontwikkeling. We werken hier samen
                aan met diverse overheidsorganisaties en eindgebruikers.
              </p>
              <p className="">
                Heb je vragen of mis je informatie?{" "}
                <Link
                  to="/contact"
