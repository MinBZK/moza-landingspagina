  ...
  return (
    <>
      ...
      <div className="">
        <Container>
          <div className="">
            <div className="rounded-xs rounded-tr-4xl bg-[#d9ebf7] xs:w-full flex flex-col p-4 pb-3 mb-8 lg:w-2/3">
              <p className="">
                ...
                </svg> MijnOverheid Zakelijk is in ontwikkeling. We doen dit samen met diverse overheidsorganisaties en eindgebruikers.
              </p>
              <p className="">
                Heb je vragen of mis je informatie? Neem contact op met: <a href="mailto:vragen@mijnoverheidzakelijk.nl" className="text-sky-700 hover:text-sky-900 hover:underline">vragen@mijnoverheidzakelijk.nl</a>
              </p>
            </div>
          </div>
        </Container>
